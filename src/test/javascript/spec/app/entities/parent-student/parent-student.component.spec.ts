...
import { ParentStudentComponent } from 'app/entities/parent-student/parent-student.component';
...
describe('Component Tests', () => {
    describe('ParentStudent Management Component', () => {
        let comp: ParentStudentComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ParentStudentComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.parentStudents[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
